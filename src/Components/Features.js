...
const Features = () => {
  return (
    ...
    class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        >
            <a href="#" class="shadow shadow-lg bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-blue-400 mb-2">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <motion.div class="shadow shadow-lg bg-gradient-to-br from-[#1d1d1d] to-[#0c0c0c] dark:bg-gray-800 border-none rounded-lg p-8 md:p-12" 
            whileHover={{
                scale:1.05
            }}>
                <a href="#" class="shadow shadow-lg bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-green-400 mb-2">
                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <motion.div class="shadow shadow-lg bg-gradient-to-br from-[#1d1d1d] to-[#0c0c0c] border-none rounded-lg p-8 md:p-12"
            whileHover={{
                scale:1.05
            }}
            >
                <a href="#" class="shadow shadow-lg bg-purple-100 text-purple-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-purple-400 mb-2">
                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
