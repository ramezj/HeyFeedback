...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <div className="flex justify-center">
             <Link className="btn btn-ghost normal-case text-2xl mt-4 font-bold mr-1 dark:hover:bg-[#0e0e0e]" href="/">🚀 HeyFeedback</Link>
         </div>
         <br></br>
      <ul class="space-y-2 font-medium">
         <li>
            ...
            <span class="flex-1 ml-3 whitespace-nowrap font-bold">{session.user.name}</span>
            </Link>
         </li>
         <li>
            {
               ...
               <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
               <span class="flex-1 ml-3 whitespace-nowrap cursor-pointer font-bold">Manage Subscription</span>
               </a>
               </>
               : <>
               <a onClick={(()=> {
            Paddle.Checkout.open({
              ...
              success:'/success'
               ...
               <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
               <span class="flex-1 ml-3 whitespace-nowrap font-bold">Upgrade</span>
         ...
         <li>
            <a onClick={() => signOut()} class="cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#0e0e0e] dark:hover:bg-[#0e0e0e]">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap cursor-pointer font-bold">Sign Out</span>
            </a>
         </li>
      </ul>
   </div>
