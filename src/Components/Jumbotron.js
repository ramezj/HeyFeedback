...
<section>
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        <h1 className="mb-4 text-5xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-8xl bg-gradient-to-br from-white to-slate-300 inline-block text-transparent bg-clip-text">Taking Feedback Management to the Next Level. </h1>
